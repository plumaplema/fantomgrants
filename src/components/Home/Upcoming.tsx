...
const milestones = [
    {
        ...
        description: "Allowing the integration of other TNT-20 tokens, empowering various projects to leverage Quadra Theta Grants for their own development and improvement."
    },
    {
        id: 2,
        date: '2023',
        title: 'Switch to own Subchain',
    ...
    },
    {
        id: 4,
        date: '2023',
        title: 'Integrate machine learning to rate video advertisement',
        description:
            'Ahmad starts his own business consulting for companies as a fullstack developer. Clients include UK Government departments, UK banks, global fintechs and startups.'
    },
    {
